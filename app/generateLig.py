...
def generateLig(
    ...
    arquivo_complx_potentialcg_xvg = nome_arquivo + '_complx_potentialcg'
    ...
    parametro2 = '-c -d 1' 
    parametro3 = '-bt'
    parametro4 = 'cubic -o ' + arquivo_complx_gro
    ...
    parametro5 = '-p ' + arquivo_livre_top 
