...
this.adapterModelCount = (adapter == null ? 1 : adapter.getAtomSetCount (asc, -1));
...
if (bs2D != null && (this.doMinimize || this.is2D)) {
bs2D.setBits (this.baseAtomIndex, this.baseAtomIndex + nAtoms);
}if (adapter == null) {
