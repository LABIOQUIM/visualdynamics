...
Clazz.defineMethod (c$, "getStrFormatForState", 
function () {
...
this.strFormat = this.strFormat.substring (0, 2) + md.strFormat.substring (2);
}if (md.text != null) {
if (this.text == null) {
this.text = md.text;
} else {
if (md.text.font != null) this.text.font = md.text.font;
this.text.text = null;
