...
this.setHoverLabel ("atomMenu", "Click or click+drag for " + this.pickAtomAssignType);
...
var atomicNumber = ("PlMiX".indexOf (type) >= 0 ? -1 : type.equals ("Xx") ? 0 : JU.PT.isUpperCase (type.charAt (0)) ? JU.Elements.elementNumberFromSymbol (type, true) : -1);
var isDelete = false;
if (atomicNumber >= 0) {
...
bs.set (index2);
var bsBond = this.vwr.ms.getBondsForSelectedAtoms (bs, false);
...
bsBond = this.vwr.ms.getBondsForSelectedAtoms (bs, false);
this.vwr.sm.setStatusStructureModified (bsBond.nextSetBit (0), modelIndex, -6, "OK", 1, bs);
if (type != '1') {
