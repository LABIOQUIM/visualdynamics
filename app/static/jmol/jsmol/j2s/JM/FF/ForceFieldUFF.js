...
if (this.ffParams == null) JM.FF.ForceFieldUFF.uff2DParams = this.ffParams = this.getParameters (true);
} else {
this.name = "UFF";
this.ffParams = JM.FF.ForceFieldUFF.uffParams;
if (this.ffParams == null) JM.FF.ForceFieldUFF.uffParams = this.ffParams = this.getParameters (false);
}}, "JM.Minimizer,~B");
...
var resourceName = (isQuick ? "UFF_2d.txt" : "UFF.txt");
var br = null;
try {
