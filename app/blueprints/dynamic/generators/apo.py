...
def generate(
    ...
    if neutralize:
        commands.extend(
            [
                ...
                f'{gmx} mdrun -nt 6 -v -s "{filename}_charged.tpr" -deffnm "{filename}_sd_em"\n',
    ...
    commands.extend(
        [
            ...
            f'{gmx} mdrun -nt 6 -v -s "{filename}_cg_em.tpr" -deffnm "{filename}_cg_em"\n',
            ...
            f'{gmx} mdrun -nt 6 -v -s "{filename}_nvt.tpr" -deffnm "{filename}_nvt"\n',
            ...
            f'{gmx} mdrun -nt 6 -v -s "{filename}_npt.tpr" -deffnm "{filename}_npt"\n',
            ...
            f'{gmx} mdrun -nt 6 -v -s "{filename}_pr.tpr" -deffnm "{filename}_pr"\n\n',
            "#analyzemd\n",
