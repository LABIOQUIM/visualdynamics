...
class GeneratePRODRG(Resource):
    def post(self):
        ...
        commands = [
            ...
            f'{gmx} mdrun -nt {Config.GMX_NT} -v -s "{filename}_complx_em.tpr" -deffnm "{filename}_complx_sd_em"\n',
            ...
            f'{gmx} mdrun -nt {Config.GMX_NT} -v -s "{filename}_complx_cg_em.tpr" -deffnm "{filename}_complx_cg_em"\n',
            ...
            f'{gmx} mdrun -nt {Config.GMX_NT} -v -s "{filename}_complx_nvt.tpr" -deffnm "{filename}_complx_nvt"\n',
            ...
            f'{gmx} mdrun -nt {Config.GMX_NT} -v -s "{filename}_complx_npt.tpr" -deffnm "{filename}_complx_npt"\n',
            ...
            f'{gmx} mdrun -nt {Config.GMX_NT} -v -s "{filename}_complx_pr.tpr" -deffnm "{filename}_complx_pr"\n\n',
            "#analyzemd\n",
