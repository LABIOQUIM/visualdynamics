...
export const LINK_STYLES = `text-primary-700/90 underline decoration-primary-800/30 underline-offset-2 transition-all hover:text-primary-700 hover:decoration-primary-800/50`;
...
export const HEADING_LINK_ANCHOR = `before:content-['•'] before:mr-1 before:text-primary-900 hover:before:text-primary-900/50`;
