...
- Be aware that sometimes simulations finish successfully and get empty analysis graphics. This means that the simulation didn't end the way it is intended to. In these cases you *must* check the logs. We're working to improve this detection. 
